...
public interface AccountResource {
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public HttpInvoker.HttpResponse getAllAccountHttpResponse(
			...
			if (pageNumber != null) {
				httpInvoker.parameter("pageNumber", String.valueOf(pageNumber));
			}
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/amf-registration-rest/v1.0/account");
		...
		public HttpInvoker.HttpResponse deleteAccountHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/amf-registration-rest/v1.0/account/{accountId}");
		...
		public HttpInvoker.HttpResponse deleteAccountBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/amf-registration-rest/v1.0/account/batch");
