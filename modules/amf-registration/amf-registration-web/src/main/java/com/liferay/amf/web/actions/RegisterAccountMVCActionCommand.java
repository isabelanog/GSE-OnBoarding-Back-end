...
public class RegisterAccountMVCActionCommand extends BaseMVCActionCommand {
    ...
    protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
        ...
        String lasttName = ParamUtil.getString(actionRequest, "lastName");
        ...
        _accountLocalService.createAccount(firstName,lasttName,emailAddress,accountName,gender,birthday,password,
