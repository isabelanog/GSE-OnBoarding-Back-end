...
public class AccountUtil {
	 ...
	 * @throws NoSuchAccountException if a matching account could not be found
	 */
	public static Account findByUUID_G(String uuid, long groupId)
		throws com.liferay.amf.exception.NoSuchAccountException {
	 ...
	 */
	public static Account fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching account, or <code>null</code> if a matching account could not be found
	 */
	public static Account fetchByUUID_G(
	 ...
	 */
	public static Account removeByUUID_G(String uuid, long groupId)
		throws com.liferay.amf.exception.NoSuchAccountException {
