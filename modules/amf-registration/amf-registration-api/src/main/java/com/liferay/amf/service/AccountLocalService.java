...
public interface AccountLocalService
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Account> getAccountsByUuidAndCompanyId(
